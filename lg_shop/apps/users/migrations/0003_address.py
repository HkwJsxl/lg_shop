# Generated by Django 3.2.20 on 2023-08-07 12:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('areas', '0001_initial'),
        ('users', '0002_userinfo_email_actived'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=64, verbose_name='地址名称')),
                ('receiver', models.CharField(max_length=32, verbose_name='收货人')),
                ('place', models.CharField(max_length=64, verbose_name='地址')),
                ('mobile', models.CharField(max_length=11, verbose_name='手机')),
                ('tel', models.CharField(blank=True, default='', max_length=32, null=True, verbose_name='固定电话')),
                ('email', models.CharField(blank=True, default='', max_length=32, null=True, verbose_name='电子邮箱')),
